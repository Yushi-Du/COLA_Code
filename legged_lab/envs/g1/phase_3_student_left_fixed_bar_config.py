"""Phase-3 student with the bar fixed to the left wrist."""
...
@configclass
class Phase3StudentLeftFixedBarEnvCfg(CollaborationEnvCfg):
...
@configclass
class Phase3StudentLeftFixedBarAgentCfg(StudentAgentCfg):
    experiment_name: str = "cola_phase_3_student_left_fixed_bar"
    wandb_project: str = "cola_phase_3_student_left_fixed_bar"
...
__all__ = ["Phase3StudentLeftFixedBarAgentCfg", "Phase3StudentLeftFixedBarEnvCfg"]
