"""Phase-2 teacher with the bar fixed to the right wrist."""
...
@configclass
class Phase2TeacherRightFixedBarEnvCfg(CollaborationEnvCfg):
...
@configclass
class Phase2TeacherRightFixedBarAgentCfg(TeacherAgentCfg):
    experiment_name: str = "cola_phase_2_teacher_right_fixed_bar"
    wandb_project: str = "cola_phase_2_teacher_right_fixed_bar"
...
__all__ = ["Phase2TeacherRightFixedBarAgentCfg", "Phase2TeacherRightFixedBarEnvCfg"]
